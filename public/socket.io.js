...
(this, (function () {
        ...
        S = function (t, e) {
            if (C) {
                var n = function (t) {
                    ...
                    h = new Uint8Array(u);
                    for (e = 0; e < a; e += 4)
                        n = R[t.charCodeAt(e)], r = R[t.charCodeAt(e + 1)], i = R[t.charCodeAt(e + 2)], o = R[t.charCodeAt(e + 3)], h[c++] = n << 2 | r >> 4, h[c++] = (15 & r) << 4 | i >> 2, h[c++] = (3 & i) << 6 | 63 & o;
                    return u
                }
                (t);
                return N(n, e)
            ...
            return r(i, [{
                        ...
                        value: function () {
                            if (this.check()) {
                                ...
                                n = st ? {}
                                 : j(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        ...
        function ft(t) {
            ...
            for (var i, o, s = ut.exec(t || ""), a = {}, c = 14; c--; )
                a[ht[c]] = s[c] || "";
            return -1 != n && -1 != r && (a.source = e, a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":"), a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), a.ipv6uri = !0),
            ...
            (0, a.path),
            a.queryKey = (i = a.query, o = {}, i.replace(/(?:^|&)([^&=]*)=?([^&]*)/g, (function (t, e, n) {
                        e && (o[e] = n)
                    })), o),
            a
        }
                            ...
                            for (var t, e = 1, n = 0; n < this.writeBuffer.length; n++) {
                                ...
                                if (r && (e += "string" == typeof(t = r) ? function (t) {
                                        for (var e = 0, n = 0, r = 0, i = t.length; r < i; r++)
                                            (e = t.charCodeAt(r))
                                                 < 128 ? n += 1 : e < 2048 ? n += 2 : e < 55296 || e >= 57344 ? n += 3 : (r++, n += 4);
                                            return n
                                        }
        ...
        var xt = function (n) {
            ...
            return r(s, [{
                        ...
                        value: function (t, e) {
                            var n = this.nsps[t];
                            return n ? this._autoConnect && !n.active && n.connect() : (n = new St(this, t, e), this.nsps[t] = n),
                            n
                        }
                    }, {
                        key: "_destroy",
        ...
        function Pt(e, n) {
            ...
            return n.forceNew || n["force new connection"] || !1 === n.multiplex || c ? r = new xt(o, n) : (Lt[s] || (Lt[s] = new xt(o, n)), r = Lt[s]),
